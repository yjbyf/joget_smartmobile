...
public class Constants {
	...
	public static void initWorkFlowConstants(String baseUrl, String identifination) {
		...
		JOGET_WORKlIST_URL = JOGET_BASE_URL + "json/workflow/assignment/list/pending" + JOGET_SERVER_IDENTIFINATION
				+ "&loginAs=" + V_LOGIN_AS;
		JOGET_DO_ACITIVITY_URL = JOGET_BASE_URL + "json/workflow/assignment/completeWithVariable/" + V_ACTIVITY_ID
				+ JOGET_SERVER_IDENTIFINATION + "&loginAs=" + V_LOGIN_AS;// +
																			// "&var_status="
																			// +
																			// V_VAR_STATUS;
